...
class MPU6050:
    ...
    def set_sample_rate(self, sample_rate):
        ...
        self.i2c.writeto_mem(self.address, SMPLRT_DIV,
                             bytearray([sample_rate]))
    ...
    def set_accel_range(self, accel_range):
        ...
        self.i2c.writeto_mem(self.address, ACCEL_CONFIG,
                             bytearray([accel_range]))
    ...
    def get_accel_angles(self):
        ...
        # roll - axis x (deg)
        phi = math.atan2(ay, math.sqrt(
            ax ** 2.0 + az ** 2.0)) * 180.0 / math.pi
        # pitch - axis y (deg)
        theta = math.atan2(-ax, math.sqrt(ay ** 2.0 +
                           az ** 2.0)) * 180.0 / math.pi
    ...
    def set_gyro_range(self, gyro_range):
        ...
        # Write the new range to the ACCEL_CONFIG register
        self.i2c.writeto_mem(self.address, GYRO_CONFIG,
                             bytearray([gyro_range]))
    ...
    def set_filter_range(self, filter_range=FILTER_BW_256):
        ...
        EXT_SYNC_SET = int.from_bytes(
            EXT_SYNC_SET_bytes, 'little') & 0b00111000
        self.i2c.writeto_mem(self.address, MPU_CONFIG,
                             bytearray([EXT_SYNC_SET | filter_range]))
    ...
    def get_angle_xy(self):
        ...
        self.phi_hat = (1 - alpha) * (self.phi_hat +
                                      dt * phi_dot) + alpha * phi_hat_acc
        self.theta_hat = (1 - alpha) * (self.theta_hat +
                                        dt * theta_dot) + alpha * theta_hat_acc
